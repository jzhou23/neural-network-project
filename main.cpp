...
//int main()
//{
//    ifstream myfile("/Users/Jhzhou/Desktop/neural network/forTest2.txt");
//    if (myfile.fail()) {
...
//        stringstream ss(line);
//        
//        vector<double> inputValues, targets;
//        for (int i = 0; i < 256; i++) {
//            double temp;
//            ss >> temp;
...
int main()
{
    ...
    while (!trainData.isEof()) {
        ...
        if (trainData.getNextInputs(inputVals, targetVals) != topology[0]) {        //compare the size
            cout <<"lalla"<<endl;
